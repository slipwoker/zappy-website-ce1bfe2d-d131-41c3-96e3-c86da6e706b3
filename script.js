...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (contactForm) {
    contactForm.addEventListener('submit', async function(e) {
      ...
      if (!fullName || !email || !phone || !subject || !terms) {
      ...
      if (!window.zappyContactFormLoaded) {
        try {
          ...
          const zappyPayload = {
            websiteId: 'ce1bfe2d-d131-41c3-96e3-c86da6e706b3',
            name: fullName,
            email: email,
          ...
          if (company) {
            zappyPayload.message = `Company: ${company}\n\n${zappyPayload.message}`;
          }
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "טל הלר משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
